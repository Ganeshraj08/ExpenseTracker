            ...
            <CardContent className="space-y-4">
               <div className="flex items-center max-md:gap-2 justify-between">
                  <div>
                     ...
                     <p className="text-sm max-md:hidden text-slate-500 dark:text-slate-400">Select your preferred interface theme.</p>
                  </div>
                  <div className="flex f bg-slate-100 dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700">
                     <button
                  ...
                  <div className="flex items-center justify-between">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           ...
                           <p className="max-md:hidden text-sm text-slate-500 dark:text-slate-400">{user.email}</p>
                        </div>
                     </div>
                     <Button variant="outline" onClick={logout} className="text-red-600 max-md:text-sm hover:bg-red-50 hover:text-red-700 dark:text-red-400 dark:hover:bg-red-900/20 dark:border-slate-700">
                        Sign Out
                     </Button>
                  </div>
               ) : (
               ...
               <Card>
                  <CardHeader className="flex flex-row items-center justify-between pb-2">
                     ...
                     <Button onClick={handleAddParent} size="sm" variant="outline" className="h-8 gap-1">
                        <Plus className="w-4 h-4" /> Add <span className="max-md:hidden">Category</span>
                     </Button>
                  </CardHeader>
                  <CardContent>
